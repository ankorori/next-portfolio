        ...
        <footer className="bg-blue-200 p-4">
          ...
          <span className="inline-flex">
            ...
            <a className="ml-4 text-gray-500" href='https://twitter.com/tkc13687936/'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
                <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
              </svg>
            </a>
            <a className="ml-4 text-gray-500" href='https://qiita.com/tkc13687936'>
          ...
          <br></br>
                <p>©{new Date().getFullYear()} takashi miyagawa </p>
        </div>
        </footer>
        </>
    )
